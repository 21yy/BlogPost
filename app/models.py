...
article_types = {u'develop languages': ['Python', 'Java', 'JavaScript'],
                 'Linux world': [u'Linux learning', 'CentOS', 'Ubuntu'],
                 u'network technology': [u'else'],
                 u'database': ['MySQL', 'Redis'],
                 u'my life': [u'daily life', u'life in university'],
                 u'Web Development': ['Flask', 'Django']}
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'Web Development', u'database', u'network technology', u'my life',
                 u'Linux world', u'develop languages']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
            db.session.commit()
...
class ArticleType(db.Model):
    ...
    def insert_system_articleType():
        articleType = ArticleType(name=u'non-category',
                                  introduction=u'system default category, can not deleted',
...
class BlogInfo(db.Model):
    ...
    def insert_blog_info():
        blog_info = BlogInfo(title='Individual Blog System',
                                  signature='Everyone manage their own Blog.',
                                  navbar='inverse')
...
class Plugin(db.Model):
    ...
    def insert_system_plugin():
        plugin = Plugin(title=u'Blog Summary',
                        note=u'System Plugin',
